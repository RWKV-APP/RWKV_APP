...
> 开发环境要求 **Flutter 3.44.0+**（推荐使用 stable channel）。
...
- **Flutter：** 一款用于构建跨平台用户界面的开源框架，支持 Android、iOS、Windows、macOS 和 Linux。
...
- [**Flutter 封装层**](https://github.com/RWKV-APP/rwkv_mobile_flutter)
