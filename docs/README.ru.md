...
> Для разработки требуется **Flutter 3.44.0+** (рекомендуется stable channel).
...
- **Flutter:** Фреймворк с открытым исходным кодом для создания кроссплатформенных пользовательских интерфейсов, поддерживающий Android, iOS, Windows, macOS и Linux.
