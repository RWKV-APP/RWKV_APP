...
- `tools/fastlane/apple_auth_gate.rb`: fresh Apple ID preauthentication and optional API-key selection
- `tools/fastlane/apple_auth_gate_test.rb`: focused preauthentication, isolated-session, and ordering regression tests
