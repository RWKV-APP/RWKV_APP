...
extension $RWKVLoad on _RWKV {
  ...
  FV loadOthello() async {
    ...
    final tokenizerPath = await fromAssetsToTemp("assets/config/tts/b_othello_vocab.txt");

    if (Platform.isIOS || Platform.isMacOS) {
      modelPath = await fromAssetsToTemp("assets/model/tts/rwkv7_othello_26m_L10_D448_extended.st");
      backend = Backend.webRwkv;
    } else {
      modelPath = await fromAssetsToTemp("assets/model/tts/rwkv7_othello_26m_L10_D448_extended-ncnn.bin");
      await fromAssetsToTemp("assets/model/tts/rwkv7_othello_26m_L10_D448_extended-ncnn.param");
