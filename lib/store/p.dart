...
part "backend.dart";
part "chat.dart";
part "chat_batch.dart";
part "chat_debug_repro.dart";
part "chat_generation_completion.dart";
...
part "chat_response_style.dart";
part "chat_sensitive.dart";
part "chat_stream_events.dart";
part "chat_token_count.dart";
part "chat_web_search.dart";
