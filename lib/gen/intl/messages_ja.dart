...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m32(commitId) => "推論エンジンバージョン: ${commitId}";

  static String m33(percent) => "読み込み${percent}%";

  static String m34(folderName) => "ローカルフォルダ：${folderName}";

  static String m35(memUsed, memFree) => "使用メモリ：${memUsed}、残りメモリ：${memFree}";

  static String m36(count) => "キューに ${count} 件のメッセージがあります";

  static String m37(text) => "モデル出力: ${text}";

  static String m38(socName) => "お使いのチップ ${socName} の NPU サポートはまだ利用できません";

  static String m39(takePhoto) =>
      "${takePhoto} をクリックしてください。RWKV が画像内のテキストを翻訳します。";

  static String m40(error) => "空のフォルダの作成に失敗しました：${error}";

  static String m41(os) => "現在のOS（${os}）ではフォルダを開く操作はサポートされていません。";

  static String m42(path) => "パス：${path}";

  static String m43(value) => "Penalty Decay: ${value}";

  static String m44(index) => "メッセージ ${index} に設定するサンプラーとペナルティパラメータを選択してください";

  static String m45(percent) => "プレフィル進捗 ${percent}";
  ...
  static String m48(count) => "キュー内：${count}";

  static String m49(count) => "このモデルは ${count} 種の応答スタイルに対応していません";

  static String m50(count) => "選択された ${count}";

  static String m51(text) => "ソーステキスト: ${text}";

  static String m52(text) => "ターゲットテキスト: ${text}";

  static String m53(value) => "Temperature: ${value}";

  static String m54(footer) => "推論${footer}-英語";

  static String m55(footer) => "推論${footer}-英語 長";

  static String m56(footer) => "推論${footer}-英語 短";

  static String m57(footer) => "推論${footer}-速い";

  static String m58(footer) => "推論${footer}-自動";

  static String m59(footer) => "推論${footer}-高";

  static String m60(footer) => "推論${footer}-オフ";

  static String m61(value) => "Top P: ${value}";

  static String m62(count) => "総テスト項目: ${count}";

  static String m63(port) => "WebSocketサービス（ポート：${port}）";

  static String m64(id) => "ウィンドウ ${id}";
  ...
  static String m67(count) => "${count}個のタブ";

  static String m68(modelName) => "現在、${modelName}を使用しています";
