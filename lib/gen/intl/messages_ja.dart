...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m24(path) => "メッセージ履歴は以下のフォルダに保存されます:\n ${path}";

  static String m25(error) => "ファイルの削除に失敗しました: ${error}";
  ...
  static String m28(port) => "HTTPサービス（ポート：${port}）";

  static String m29(flag, nameCN, nameEN) =>
      "${flag} ${nameCN}(${nameEN})の音声を模倣";

  static String m30(fileName) => "${fileName}を模倣";

  static String m31(count) => "インポート成功：${count} 個のファイルをインポートしました";

  static String m32(percent) => "読み込み${percent}%";

  static String m33(folderName) => "ローカルフォルダ：${folderName}";

  static String m34(memUsed, memFree) => "使用メモリ：${memUsed}、残りメモリ：${memFree}";

  static String m35(count) => "キューに ${count} 件のメッセージがあります";

  static String m36(text) => "モデル出力: ${text}";

  static String m37(socName) => "お使いのチップ ${socName} の NPU サポートはまだ利用できません";

  static String m38(takePhoto) =>
      "${takePhoto} をクリックしてください。RWKV が画像内のテキストを翻訳します。";

  static String m39(error) => "空のフォルダの作成に失敗しました：${error}";

  static String m40(os) => "現在のOS（${os}）ではフォルダを開く操作はサポートされていません。";

  static String m41(path) => "パス：${path}";

  static String m42(value) => "Penalty Decay: ${value}";

  static String m43(index) => "メッセージ ${index} に設定するサンプラーとペナルティパラメータを選択してください";

  static String m44(percent) => "プレフィル進捗 ${percent}";
  ...
  static String m47(count) => "キュー内：${count}";

  static String m48(count) => "このモデルは ${count} 種の応答スタイルに対応していません";

  static String m49(count) => "選択された ${count}";

  static String m50(text) => "ソーステキスト: ${text}";

  static String m51(text) => "ターゲットテキスト: ${text}";

  static String m52(value) => "Temperature: ${value}";

  static String m53(footer) => "推論${footer}-英語";

  static String m54(footer) => "推論${footer}-英語 長";

  static String m55(footer) => "推論${footer}-英語 短";

  static String m56(footer) => "推論${footer}-速い";

  static String m57(footer) => "推論${footer}-自動";

  static String m58(footer) => "推論${footer}-高";

  static String m59(footer) => "推論${footer}-オフ";

  static String m60(value) => "Top P: ${value}";

  static String m61(count) => "総テスト項目: ${count}";

  static String m62(port) => "WebSocketサービス（ポート：${port}）";

  static String m63(id) => "ウィンドウ ${id}";
  ...
  static String m66(count) => "${count}個のタブ";

  static String m67(modelName) => "現在、${modelName}を使用しています";
