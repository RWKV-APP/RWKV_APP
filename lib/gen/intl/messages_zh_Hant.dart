...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(index) => "請選擇要為第 ${index} 條消息設定的取樣和懲罰參數";

  static String m21(value) => "Presence Penalty: ${value}";

  static String m22(count) => "排隊中: ${count}";

  static String m23(count) => "已選擇 ${count}";

  static String m24(text) => "來源文字: ${text}";

  static String m25(text) => "目標文字: ${text}";

  static String m26(value) => "Temperature: ${value}";

  static String m27(footer) => "推理${footer}: 英";

  static String m28(footer) => "推理${footer}: 英長";
  ...
  static String m33(footer) => "推理${footer}: 關";

  static String m34(value) => "Top P: ${value}";

  static String m35(count) => "總測試項: ${count}";

  static String m36(port) => "WebSocket 服務 (連接埠: ${port})";

  static String m37(id) => "視窗 ${id}";

  static String m38(count) => "${count} 個分頁";

  static String m39(modelName) => "您目前正在使用 ${modelName}";
