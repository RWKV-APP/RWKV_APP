...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m32(count) => "排队中: ${count}";

  static String m33(count) => "已选择 ${count}";

  static String m34(text) => "源文本: ${text}";

  static String m35(text) => "目标文本: ${text}";

  static String m36(value) => "Temperature: ${value}";

  static String m37(footer) => "推理${footer}-英";

  static String m38(footer) => "推理${footer}-英长";

  static String m39(footer) => "推理${footer}-英短";

  static String m40(footer) => "推理${footer}-快";

  static String m41(footer) => "推理${footer}-中";

  static String m42(footer) => "推理${footer}-高";

  static String m43(footer) => "推理${footer}-关";

  static String m44(value) => "Top P: ${value}";

  static String m45(count) => "总测试项: ${count}";

  static String m46(port) => "WebSocket 服务 (端口: ${port})";

  static String m47(id) => "窗口 ${id}";

  static String m48(count) => "${count} 个标签页";

  static String m49(modelName) => "您当前正在使用 ${modelName}";
