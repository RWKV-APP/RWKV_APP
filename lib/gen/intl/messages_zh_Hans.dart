...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m24(path) => "路径：${path}";

  static String m25(value) => "Penalty Decay: ${value}";

  static String m26(index) => "请选择要为第 ${index} 条消息设置的采样和惩罚参数";

  static String m27(value) => "Presence Penalty: ${value}";

  static String m28(count) => "排队中: ${count}";

  static String m29(count) => "已选择 ${count}";

  static String m30(text) => "源文本: ${text}";

  static String m31(text) => "目标文本: ${text}";

  static String m32(value) => "Temperature: ${value}";

  static String m33(footer) => "推理${footer}-英";

  static String m34(footer) => "推理${footer}-英长";

  static String m35(footer) => "推理${footer}-英短";

  static String m36(footer) => "推理${footer}-快";

  static String m37(footer) => "推理${footer}-中";

  static String m38(footer) => "推理${footer}-高";

  static String m39(footer) => "推理${footer}-关";

  static String m40(value) => "Top P: ${value}";

  static String m41(count) => "总测试项: ${count}";

  static String m42(port) => "WebSocket 服务 (端口: ${port})";

  static String m43(id) => "窗口 ${id}";

  static String m44(count) => "${count} 个标签页";

  static String m45(modelName) => "您当前正在使用 ${modelName}";
