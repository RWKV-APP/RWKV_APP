...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m17(text) => "Model output: ${text}";

  static String m18(socName) =>
  ...
  static String m21(index) =>
      "Please select the sampler and penalty parameters to set for message ${index}";

  static String m22(value) => "Presence Penalty: ${value}";

  static String m23(count) => "Queued: ${count}";

  static String m24(count) => "Selected ${count}";

  static String m25(text) => "Source Text: ${text}";

  static String m26(text) => "Target Text: ${text}";

  static String m27(value) => "Temperature: ${value}";

  static String m28(footer) => "Reasoning${footer}: EN";

  static String m29(footer) => "Reasoning${footer}: EN Long";

  static String m30(footer) => "Reasoning${footer}: EN Short";

  static String m31(footer) => "Reasoning${footer}: Fast";

  static String m32(footer) => "Reasoning${footer}: Auto";

  static String m33(footer) => "Reasoning${footer}: High";

  static String m34(footer) => "Reasoning${footer}: Off";

  static String m35(value) => "Top P: ${value}";

  static String m36(count) => "Total Test Items: ${count}";

  static String m37(port) => "WebSocket Service (Port: ${port})";

  static String m38(id) => "Window ${id}";

  static String m39(count) => "${count} tabs";

  static String m40(modelName) => "You are now using ${modelName}";
