...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m22(count) => "Queued: ${count}";

  static String m23(count) => "Selected ${count}";

  static String m24(text) => "Source Text: ${text}";

  static String m25(text) => "Target Text: ${text}";

  static String m26(value) => "Temperature: ${value}";

  static String m27(footer) => "Reasoning${footer}: EN";

  static String m28(footer) => "Reasoning${footer}: EN Long";

  static String m29(footer) => "Reasoning${footer}: EN Short";

  static String m30(footer) => "Reasoning${footer}: Fast";

  static String m31(footer) => "Reasoning${footer}: Auto";

  static String m32(footer) => "Reasoning${footer}: High";

  static String m33(footer) => "Reasoning${footer}: Off";

  static String m34(value) => "Top P: ${value}";

  static String m35(count) => "Total Test Items: ${count}";

  static String m36(port) => "WebSocket Service (Port: ${port})";

  static String m37(id) => "Window ${id}";

  static String m38(count) => "${count} tabs";

  static String m39(modelName) => "You are now using ${modelName}";
