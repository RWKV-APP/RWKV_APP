...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(completed, total, passed, failed, invalid) =>
      "Завершено ${completed}/${total} · УСПЕХ ${passed} · ОШИБКА ${failed} · НЕДЕЙСТВИТЕЛЬНО ${invalid}";

  static String m1(current, total, name) =>
      "Выполняется ${current}/${total} · ${name}";

  static String m2(tools) => "Инструменты: ${tools}";

  static String m3(turn, title) => "Шаг ${turn} · ${title}";

  static String m4(dlls) =>
      "Отсутствуют runtime DLL: ${dlls}\nИспользуйте полный bundle Albatross и держите папку lib рядом с исполняемым файлом";

  static String m5(error) => "Ошибка: ${error}";

  static String m6(error) => "Не удалось запустить API сервер: ${error}";

  static String m7(port) => "API сервер запущен на порту ${port}";

  static String m8(count) => "Ветка × ${count}";

  static String m9(count) => "Каждый вывод сгенерирует ${count} сообщений";

  static String m10(count) => "Каждый вывод сгенерирует ${count} результата";

  static String m11(count) => "Параллельный инференс: ${count} выходов";

  static String m12(index) => "Выбран выход ${index}";
  ...
  static String m16(count) => "Поддерживается до Batch ${count}";
  ...
  static String m19(speed) => "Пик Decode: ${speed} t/s";
  ...
  static String m23(demoName) => "Добро пожаловать в ${demoName}";

  static String m24(maxLength) =>
      "Название диалога не может превышать ${maxLength} символов";

  static String m25(length) => "ctx ${length}";

  static String m26(modelName) => "Текущая модель: ${modelName}";

  static String m27(current, total) => "Текущий прогресс: ${current}/${total}";

  static String m28(current, total) =>
  ...
  static String m31(error) => "Не удалось удалить файл: ${error}";
  ...
  static String m34(port) => "HTTP-сервис (Порт: ${port})";

  static String m35(flag, nameCN, nameEN) =>
      "Имитировать голос ${flag} ${nameEN} (${nameCN})";

  static String m36(fileName) => "Имитировать ${fileName}";

  static String m37(count) => "Импорт успешен: импортировано ${count} файлов";

  static String m38(commitId) => "Версия ИИ-движка: ${commitId}";

  static String m39(percent) => "Загрузка ${percent}%";

  static String m40(folderName) => "Локальная папка: ${folderName}";

  static String m41(memUsed, memFree) =>
      "Использовано памяти: ${memUsed}, Свободно памяти: ${memFree}";

  static String m42(count) => "В очереди ${count} сообщений";

  static String m43(text) => "Вывод модели: ${text}";

  static String m44(socName) =>
      "Поддержка NPU для вашего чипа ${socName} пока недоступна";

  static String m45(takePhoto) =>
      "Нажмите ${takePhoto}. RWKV переведет текст на изображении.";

  static String m46(error) => "Не удалось создать пустую папку: ${error}";

  static String m47(os) =>
      "Открытие папки не поддерживается в текущей ОС (${os}).";

  static String m48(name) => "О параметре ${name}";

  static String m49(path) => "Путь: ${path}";

  static String m50(value) => "Penalty Decay: ${value}";

  static String m51(index) =>
      "Пожалуйста, выберите параметры сэмплера и штрафов для сообщения ${index}";

  static String m52(percent) => "Прогресс prefill ${percent}";
  ...
  static String m55(count) => "В очереди: ${count}";
  ...
  static String m60(text) => "Исходный текст: ${text}";

  static String m61(text) => "Целевой текст: ${text}";

  static String m62(value) => "Temperature: ${value}";

  static String m63(footer) => "Мышление${footer}-Англ";

  static String m64(footer) => "Мышление${footer}-Англ Длинно";

  static String m65(footer) => "Мышление${footer}-Англ Коротко";

  static String m66(footer) => "Мышление${footer}-Быстро";

  static String m67(footer) => "Мышление${footer}-Авто";

  static String m68(footer) => "Мышление${footer}-Вкл";

  static String m69(footer) => "Мышление${footer}-Глупо";

  static String m70(value) => "Top P: ${value}";

  static String m71(count) => "Всего тестовых элементов: ${count}";

  static String m72(model) => "Официальное облако ${model}";

  static String m73(error) => "Ошибка Web Demo: ${error}";

  static String m74(count, backend) => "Страниц: ${count} · ${backend}";

  static String m75(index) => "Веб ${index}";

  static String m76(label) => "Исходный код: ${label}";

  static String m77(tokens, bytes) => "${tokens} токенов, ${bytes} байт";

  static String m78(port) => "WebSocket-сервис (Порт: ${port})";

  static String m79(id) => "Окно ${id}";
  ...
  static String m82(count) => "${count} вкладок";

  static String m83(modelName) => "Вы сейчас используете ${modelName}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "agent_eval_active_model_unknown": MessageLookupByLibrary.simpleMessage(
      "Не удалось определить активную модель чата для оценки Agent",
    ),
    "agent_eval_assisted_pass": MessageLookupByLibrary.simpleMessage(
      "УСПЕХ С ПОДДЕРЖКОЙ",
    ),
    "agent_eval_case": MessageLookupByLibrary.simpleMessage("Сценарий"),
    "agent_eval_completed": m0,
    "agent_eval_export": MessageLookupByLibrary.simpleMessage("Экспорт отчёта"),
    "agent_eval_export_title": MessageLookupByLibrary.simpleMessage(
      "Экспорт отчёта об оценке Agent",
    ),
    "agent_eval_fail": MessageLookupByLibrary.simpleMessage("ОШИБКА"),
    "agent_eval_invalid": MessageLookupByLibrary.simpleMessage(
      "НЕДЕЙСТВИТЕЛЬНО",
    ),
    "agent_eval_mode": MessageLookupByLibrary.simpleMessage("Режим оценки"),
    ...
    "agent_eval_no_report": MessageLookupByLibrary.simpleMessage(
      "Отчёт об оценке Agent пока недоступен",
    ),
    "agent_eval_repeats": MessageLookupByLibrary.simpleMessage("Повторы"),
    "agent_eval_run_all": MessageLookupByLibrary.simpleMessage("Запустить все"),
    "agent_eval_running": m1,
    "agent_eval_sandbox_description": MessageLookupByLibrary.simpleMessage(
      "Файлы теста хранятся только в памяти. Запуск файлов, тесты, AWK, права доступа и расписания моделируются детерминированно. Lua работает в отдельном завершаемом Isolate с лимитом 2 секунды и без доступа к сети, файлам хоста, системным командам, модулям и API отладки. Это изоляция процесса, а не жёсткая квота памяти.",
    ),
    "agent_eval_sandbox_title": MessageLookupByLibrary.simpleMessage(
      "Ограниченная среда оценки",
    ),
    ...
    "albatross_launch_config_hint": MessageLookupByLibrary.simpleMessage(
      "Host и порт используются для подключения к локальному сервису Albatross и недоступны для изменения во время работы",
    ),
    ...
    "albatross_no_logs": MessageLookupByLibrary.simpleMessage(
      "Журнала пока нет",
    ),
    "albatross_no_pth_candidates": MessageLookupByLibrary.simpleMessage(
      "Доступных PTH-моделей пока нет. Можно выбрать локальный PTH-файл",
    ),
    ...
    "albatross_selected_model": MessageLookupByLibrary.simpleMessage("Выбрано"),
    ...
    "completion_options": MessageLookupByLibrary.simpleMessage(
      "Параметры генерации",
    ),
    "completion_options_reasoning": MessageLookupByLibrary.simpleMessage(
      "Параметры генерации (рассуждение)",
    ),
    ...
    "parameter_help_frequency_penalty": MessageLookupByLibrary.simpleMessage(
      "Подавляет повторение токенов — фрагментов текста — с учётом частоты их появления. Чем чаще встречается токен, тем сильнее штраф.\n\nВыше: сильнее сокращает повторы.\nНиже: допускает больше повторений.\n\nСлишком высокое значение может нарушить связность текста.",
    ),
    "parameter_help_label": m48,
    "parameter_help_max_length": MessageLookupByLibrary.simpleMessage(
      "Задаёт предел числа токенов в одном ответе, включая сгенерированные рассуждения. Токены — это фрагменты текста, а не число символов или слов.\n\nНиже: предел достигается раньше, ответ может оборваться.\nВыше: допускается более длинный вывод, который может занять больше времени.\n\nЭто верхний предел: модель может закончить раньше.",
    ),
    "parameter_help_penalty_decay": MessageLookupByLibrary.simpleMessage(
      "Настраивает, как быстро ослабевают штрафы за повторение по мере генерации текста.\n\nНиже (например, 0.990): штрафы ослабевают быстрее, прежние слова легче использовать снова.\nВыше (например, 0.999): штрафы ослабевают медленнее, подавление повторов длится дольше.\n\nДлина контекста, который помнит модель, не меняется.",
    ),
    "parameter_help_presence_penalty": MessageLookupByLibrary.simpleMessage(
      "Снижает склонность повторно использовать токены — фрагменты текста, которые уже встречались.\n\nВыше: больше новых формулировок.\nНиже: легче повторить прежние слова.\n\nСлишком высокое значение может мешать текстам, где нужны повторяющиеся имена, термины или код.",
    ),
    "parameter_help_temperature": MessageLookupByLibrary.simpleMessage(
      "Настраивает случайность выбора следующего токена — фрагмента текста.\n\nНиже: более предсказуемые формулировки.\nВыше: больше разнообразия, но модель может отклониться от темы.\n\nЕсли сомневаетесь, оставьте значение по умолчанию. Низкое значение не гарантирует правильный ответ.",
    ),
    "parameter_help_top_p": MessageLookupByLibrary.simpleMessage(
      "Ограничивает выбор следующего токена — фрагмента текста. Модель оставляет наиболее вероятные варианты, пока их суммарная вероятность не достигнет Top P.\n\nНиже: меньше вариантов.\nВыше: больше разнообразия формулировок.\n\nНапример, 0.5 означает суммарную вероятность около 50%, а не половину словаря.",
    ),
    "path_label": m49,
    ...
    "sampler_options": MessageLookupByLibrary.simpleMessage(
      "Параметры выборки",
    ),
    "sampler_options_reasoning": MessageLookupByLibrary.simpleMessage(
      "Параметры выборки (рассуждение)",
    ),
