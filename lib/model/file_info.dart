...
class FileInfo extends Equatable {
  ...
  WorldType? get worldType => switch (fileName) {
    ...
    "modrwkv-v3-0.4b-251107-a16w8-8elite.bin" => WorldType.modrwkvV3,
    "modrwkv-v3-0.4b-251107-a16w8-8elitegen5.bin" => WorldType.modrwkvV3,
    "modrwkv-v3-0.4b-251107-a16w8-8gen2.bin" => WorldType.modrwkvV3,
    "modrwkv-v3-0.4b-251107-a16w8-8gen3.bin" => WorldType.modrwkvV3,
    "modrwkv-v3-0.4b-251107-a16w8-8sgen3.bin" => WorldType.modrwkvV3,
    "modrwkv-v3-0.4b-251107-q8_0.gguf" => WorldType.modrwkvV3,
    "modrwkv-v3-0.4b-251107-siglip-encoder-patch16-384-q8.gguf" => WorldType.modrwkvV3,
    "modrwkv-v3-0.4b-251107-vision-adapter.gguf" => WorldType.modrwkvV3,
